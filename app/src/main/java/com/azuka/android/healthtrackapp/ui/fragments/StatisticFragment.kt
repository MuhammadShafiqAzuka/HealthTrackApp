...
import com.azuka.android.healthtrackapp.ui.CustomMarkerView
import com.azuka.android.healthtrackapp.ui.viewmodels.StatisticsViewModel
...
class StatisticsFragment : Fragment(R.layout.fragment_statistic) {
    ...
    private fun subscribeToObservers() {
        ...
        viewModel.runsSortedByDate.observe(viewLifecycleOwner, Observer {
            it?.let {
                val allAvgSpeeds = it.indices.map { i -> BarEntry(i.toFloat(), it[i].avg_speed) }
